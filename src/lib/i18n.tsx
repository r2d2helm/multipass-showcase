...
export const UI: Record<string, Record<Locale, string>> = {
  ...
  // Learn page
  'nav.learn': { fr: 'Learn', en: 'Learn', nl: 'Learn' },
  'nav.learn.desc': { fr: 'Reflexion & Sagesse', en: 'Reflection & Wisdom', nl: 'Reflectie & Wijsheid' },
  'landing.desc.learn': { fr: 'Reflexions algorithmiques, wisdom frames et suivi des PRDs', en: 'Algorithm reflections, wisdom frames and PRD tracking', nl: 'Algoritmische reflecties, wijsheidskaders en PRD-tracking' },
  'nav.ecosystem': { fr: 'Ecosystem', en: 'Ecosystem', nl: 'Ecosysteem' },
  'nav.ecosystem.desc': { fr: 'Interconnexions', en: 'Interconnections', nl: 'Interconnecties' },
  'landing.desc.ecosystem': { fr: 'Visualisation interactive des interconnexions entre ecosystemes', en: 'Interactive visualization of ecosystem interconnections', nl: 'Interactieve visualisatie van ecosysteem-interconnecties' },

  // Ecosystem page
  'eco.title': { fr: 'Interconnexions Ecosysteme', en: 'Ecosystem Interconnections', nl: 'Ecosysteem Interconnecties' },
  'eco.badge': { fr: 'Temps reel', en: 'Real-time', nl: 'Realtime' },
  'eco.systems': { fr: 'systemes', en: 'systems', nl: 'systemen' },
  'eco.connections': { fr: 'connexions', en: 'connections', nl: 'verbindingen' },
  'eco.subtitle': { fr: 'Cliquez sur un noeud pour explorer ses connexions', en: 'Click a node to explore its connections', nl: 'Klik op een knooppunt om verbindingen te verkennen' },
  'eco.hint': { fr: 'Cliquez sur un noeud ou une connexion', en: 'Click a node or connection', nl: 'Klik op een knooppunt of verbinding' },
  'eco.panel.connections': { fr: 'Connexions', en: 'Connections', nl: 'Verbindingen' },

  // Ecosystem nodes
  'eco.node.pai': { fr: 'PAI System', en: 'PAI System', nl: 'PAI Systeem' },
  'eco.node.pai.desc': { fr: 'Cerveau IA — Algorithm, agents, skills, hooks', en: 'AI Brain — Algorithm, agents, skills, hooks', nl: 'AI Brein — Algorithm, agenten, skills, hooks' },
  'eco.node.multipass': { fr: 'MultiPass Agency', en: 'MultiPass Agency', nl: 'MultiPass Agency' },
  'eco.node.multipass.desc': { fr: 'Plateforme web — Next.js, Supabase, Stripe', en: 'Web platform — Next.js, Supabase, Stripe', nl: 'Webplatform — Next.js, Supabase, Stripe' },
  'eco.node.docker': { fr: 'Docker Stack', en: 'Docker Stack', nl: 'Docker Stack' },
  'eco.node.docker.desc': { fr: 'Conteneurisation — 7 stacks Compose, reseau isole', en: 'Containerization — 7 Compose stacks, isolated network', nl: 'Containerisatie — 7 Compose stacks, geisoleerd netwerk' },
  'eco.node.knowledge': { fr: 'Knowledge Base', en: 'Knowledge Base', nl: 'Kennisbank' },
  'eco.node.knowledge.desc': { fr: 'Obsidian Vault + Mem0 + Neo4j graph', en: 'Obsidian Vault + Mem0 + Neo4j graph', nl: 'Obsidian Vault + Mem0 + Neo4j graaf' },
  'eco.node.monitoring': { fr: 'Monitoring', en: 'Monitoring', nl: 'Monitoring' },
  'eco.node.monitoring.desc': { fr: 'Beszel, Uptime Kuma, watchdog externe, alertes ntfy', en: 'Beszel, Uptime Kuma, external watchdog, ntfy alerts', nl: 'Beszel, Uptime Kuma, externe watchdog, ntfy alerts' },
  'eco.node.infra': { fr: 'Infrastructure', en: 'Infrastructure', nl: 'Infrastructuur' },
  'eco.node.infra.desc': { fr: 'Dell R740, Proxmox 9, 6 VMs, NFS partage', en: 'Dell R740, Proxmox 9, 6 VMs, NFS shared', nl: 'Dell R740, Proxmox 9, 6 VMs, NFS gedeeld' },
  'eco.node.cicd': { fr: 'CI/CD', en: 'CI/CD', nl: 'CI/CD' },
  'eco.node.cicd.desc': { fr: 'GitHub Actions, E2E Playwright, self-hosted runner', en: 'GitHub Actions, E2E Playwright, self-hosted runner', nl: 'GitHub Actions, E2E Playwright, self-hosted runner' },

  // Ecosystem stats
  'eco.stat.agents': { fr: 'Agents', en: 'Agents', nl: 'Agenten' },
  'eco.stat.subagents': { fr: 'Subagents', en: 'Subagents', nl: 'Subagenten' },
  'eco.stat.skills': { fr: 'Skills', en: 'Skills', nl: 'Skills' },
  'eco.stat.hooks': { fr: 'Hooks', en: 'Hooks', nl: 'Hooks' },
  'eco.stat.routes': { fr: 'Routes', en: 'Routes', nl: 'Routes' },
  'eco.stat.tests': { fr: 'Tests', en: 'Tests', nl: 'Testen' },
  'eco.stat.containers': { fr: 'Containers', en: 'Containers', nl: 'Containers' },
  'eco.stat.stacks': { fr: 'Stacks', en: 'Stacks', nl: 'Stacks' },
  'eco.stat.healthchecks': { fr: 'Healthchecks', en: 'Healthchecks', nl: 'Healthchecks' },
  'eco.stat.notes': { fr: 'Notes', en: 'Notes', nl: 'Notities' },
  'eco.stat.chunks': { fr: 'Chunks', en: 'Chunks', nl: 'Chunks' },
  'eco.stat.graphnodes': { fr: 'Graph Nodes', en: 'Graph Nodes', nl: 'Graafknopen' },
  'eco.stat.checks': { fr: 'Checks', en: 'Checks', nl: 'Checks' },
  'eco.stat.monitors': { fr: 'Monitors', en: 'Monitors', nl: 'Monitors' },
  'eco.stat.watchdog': { fr: 'Watchdog', en: 'Watchdog', nl: 'Watchdog' },
  'eco.stat.vms': { fr: 'VMs', en: 'VMs', nl: 'VMs' },
  'eco.stat.vcpu': { fr: 'vCPU', en: 'vCPU', nl: 'vCPU' },
  'eco.stat.ram': { fr: 'RAM', en: 'RAM', nl: 'RAM' },
  'eco.stat.pipeline': { fr: 'Pipeline', en: 'Pipeline', nl: 'Pipeline' },
  'eco.stat.e2e': { fr: 'Tests E2E', en: 'E2E Tests', nl: 'E2E Testen' },
  'eco.stat.crons': { fr: 'Crons', en: 'Crons', nl: 'Crons' },

  // Ecosystem edges
  'eco.edge.pai_multipass': { fr: 'PAI developpe MultiPass', en: 'PAI develops MultiPass', nl: 'PAI ontwikkelt MultiPass' },
  'eco.edge.pai_knowledge': { fr: 'PAI lit et ecrit le savoir', en: 'PAI reads and writes knowledge', nl: 'PAI leest en schrijft kennis' },
  'eco.edge.pai_docker': { fr: 'PAI gere les containers', en: 'PAI manages containers', nl: 'PAI beheert containers' },
  'eco.edge.pai_cicd': { fr: 'PAI declenche les pipelines', en: 'PAI triggers pipelines', nl: 'PAI activeert pipelines' },
  'eco.edge.multipass_docker': { fr: 'MultiPass tourne sur Docker', en: 'MultiPass runs on Docker', nl: 'MultiPass draait op Docker' },
  'eco.edge.multipass_knowledge': { fr: 'Contenu depuis le vault', en: 'Content from vault', nl: 'Inhoud uit de vault' },
  'eco.edge.monitoring_docker': { fr: 'Surveille les containers', en: 'Monitors containers', nl: 'Bewaakt containers' },
  'eco.edge.monitoring_infra': { fr: 'Surveille les VMs', en: 'Monitors VMs', nl: 'Bewaakt VMs' },
  'eco.edge.monitoring_multipass': { fr: 'Teste les endpoints', en: 'Tests endpoints', nl: 'Test eindpunten' },
  'eco.edge.docker_infra': { fr: 'Docker sur Proxmox VMs', en: 'Docker on Proxmox VMs', nl: 'Docker op Proxmox VMs' },
  'eco.edge.knowledge_infra': { fr: 'Stockage NFS partage', en: 'NFS shared storage', nl: 'NFS gedeelde opslag' },
  'eco.edge.cicd_multipass': { fr: 'Deploy MultiPass', en: 'Deploys MultiPass', nl: 'Deployt MultiPass' },
  'eco.edge.cicd_monitoring': { fr: 'Rapports E2E et alertes', en: 'E2E reports and alerts', nl: 'E2E rapporten en alerts' },
  'eco.edge.pai_monitoring': { fr: 'PAI lit les alertes', en: 'PAI reads alerts', nl: 'PAI leest alerts' },
  'learn.title': { fr: 'Apprentissage Continu', en: 'Continuous Learning', nl: 'Continu Leren' },
  'learn.tab.reflections': { fr: 'Reflexions', en: 'Reflections', nl: 'Reflecties' },
  'learn.tab.wisdom': { fr: 'Wisdom Frames', en: 'Wisdom Frames', nl: 'Wijsheidskaders' },
  'learn.tab.prd': { fr: 'PRD Tracker', en: 'PRD Tracker', nl: 'PRD Tracker' },
  'learn.hero.headline.pre': { fr: 'Un systeme qui', en: 'A system that', nl: 'Een systeem dat' },
  'learn.hero.headline.self': { fr: 's\'ameliore tout seul', en: 'improves itself', nl: 'zichzelf verbetert' },
  'learn.hero.headline.post': { fr: 'a chaque session', en: 'with every session', nl: 'bij elke sessie' },
  'learn.hero.subtitle': { fr: 'Chaque tache executee genere des reflexions. Chaque reflexion alimente les wisdom frames. Les wisdom frames guident les sessions futures. L\'IA ne repete jamais la meme erreur.', en: 'Every executed task generates reflections. Every reflection feeds wisdom frames. Wisdom frames guide future sessions. The AI never repeats the same mistake.', nl: 'Elke uitgevoerde taak genereert reflecties. Elke reflectie voedt wijsheidskaders. Wijsheidskaders begeleiden toekomstige sessies. De AI herhaalt nooit dezelfde fout.' },
  'learn.hero.auto': { fr: 'Auto-apprentissage', en: 'Self-Learning', nl: 'Zelf-lerend' },
  'learn.loop.work': { fr: 'Executer', en: 'Execute', nl: 'Uitvoeren' },
  'learn.loop.reflect': { fr: 'Reflechir', en: 'Reflect', nl: 'Reflecteren' },
  'learn.loop.extract': { fr: 'Extraire', en: 'Extract', nl: 'Extraheren' },
  'learn.loop.store': { fr: 'Stocker', en: 'Store', nl: 'Opslaan' },
  'learn.loop.improve': { fr: 'Ameliorer', en: 'Improve', nl: 'Verbeteren' },
  'learn.compound.pre': { fr: 'Effet compose :', en: 'Compound effect:', nl: 'Samengesteld effect:' },
  'learn.compound.post': { fr: 'plus le systeme travaille, plus il devient intelligent. Les erreurs d\'hier deviennent les garde-fous d\'aujourd\'hui.', en: 'the more the system works, the smarter it becomes. Yesterday\'s mistakes become today\'s guardrails.', nl: 'hoe meer het systeem werkt, hoe slimmer het wordt. De fouten van gisteren worden de leidraden van vandaag.' },
  // Reflection questions
  'learn.q1': { fr: 'Auto-evaluation', en: 'Self-Assessment', nl: 'Zelfevaluatie' },
  'learn.q2': { fr: 'Algorithme Ideal', en: 'Ideal Algorithm', nl: 'Ideaal Algoritme' },
  'learn.q3': { fr: 'IA Superieure', en: 'Superior AI', nl: 'Superieure AI' },
  'learn.criteria': { fr: 'Criteres', en: 'Criteria', nl: 'Criteria' },
  'learn.budget': { fr: 'Budget', en: 'Budget', nl: 'Budget' },
  'learn.within': { fr: 'Respecte', en: 'Within', nl: 'Binnen' },
  'learn.over': { fr: 'Depasse', en: 'Over', nl: 'Over' },
  // Wisdom frame types
  'learn.type.principle': { fr: 'Principe', en: 'Principle', nl: 'Principe' },
  'learn.type.antipattern': { fr: 'Anti-pattern', en: 'Anti-pattern', nl: 'Anti-patroon' },
  'learn.type.rule': { fr: 'Regle Contextuelle', en: 'Contextual Rule', nl: 'Contextuele Regel' },
  'learn.type.prediction': { fr: 'Prediction', en: 'Prediction', nl: 'Voorspelling' },
  // Wisdom observations
  'learn.wf.dev.p1': { fr: 'CSS variables des le depart pour tout theme switching', en: 'CSS variables from the start for all theme switching', nl: 'CSS-variabelen vanaf het begin voor alle thema-omschakelingen' },
  'learn.wf.dev.a1': { fr: 'Ne jamais hardcoder rgba() dans des composants individuels', en: 'Never hardcode rgba() in individual components', nl: 'Nooit rgba() hardcoden in individuele componenten' },
  'learn.wf.dev.c1': { fr: 'Next.js server actions perdent l\'etat browser (cookies, PKCE)', en: 'Next.js server actions lose browser state (cookies, PKCE)', nl: 'Next.js server-acties verliezen browserstatus (cookies, PKCE)' },
  'learn.wf.dev.pr1': { fr: 'Les frameworks convergeront vers le server-first avec hydratation selective', en: 'Frameworks will converge on server-first with selective hydration', nl: 'Frameworks zullen convergeren naar server-first met selectieve hydratatie' },
  'learn.wf.deploy.p1': { fr: 'Build args Docker sont bakes at build time — --no-cache obligatoire', en: 'Docker build args are baked at build time — --no-cache required', nl: 'Docker-build-args worden bij buildtijd ingebakken — --no-cache vereist' },
  'learn.wf.deploy.a1': { fr: 'Ne pas deployer sans E2E valide sur staging', en: 'Never deploy without valid E2E on staging', nl: 'Nooit deployen zonder geldige E2E op staging' },
  'learn.wf.deploy.c1': { fr: 'Self-hosted runner necessite deploy script isole du CI', en: 'Self-hosted runner needs deploy script isolated from CI', nl: 'Zelf-gehoste runner heeft deploy-script nodig dat geisoleerd is van CI' },
  'learn.wf.infra.p1': { fr: 'Memory limits Docker explicites pour chaque container', en: 'Explicit Docker memory limits for every container', nl: 'Expliciete Docker-geheugenlimieten voor elke container' },
  'learn.wf.infra.a1': { fr: 'Ne pas laisser build cache croitre sans seuils disk', en: 'Never let build cache grow without disk thresholds', nl: 'Laat build-cache nooit groeien zonder schijfdrempels' },
  'learn.wf.infra.c1': { fr: 'POSTGRES_PASSWORD ne change qu\'a l\'init du volume', en: 'POSTGRES_PASSWORD only changes at volume init', nl: 'POSTGRES_PASSWORD verandert alleen bij volume-init' },
  'learn.wf.infra.pr1': { fr: 'Les VMs seront remplacees par des containers securises dans 2 ans', en: 'VMs will be replaced by secure containers within 2 years', nl: 'VMs worden binnen 2 jaar vervangen door beveiligde containers' },
  'learn.wf.sec.p1': { fr: 'Zero ports ouverts — Cloudflare Tunnel uniquement', en: 'Zero open ports — Cloudflare Tunnel only', nl: 'Nul open poorten — alleen Cloudflare Tunnel' },
  'learn.wf.sec.a1': { fr: 'Ne jamais stocker credentials en clair dans les repos', en: 'Never store credentials in plaintext in repos', nl: 'Nooit inloggegevens in platte tekst opslaan in repo\'s' },
  'learn.wf.sec.c1': { fr: 'UFW + SSH hardening + unattended-upgrades sur chaque VM', en: 'UFW + SSH hardening + unattended-upgrades on every VM', nl: 'UFW + SSH-hardening + unattended-upgrades op elke VM' },
  'learn.wf.comm.p1': { fr: 'ntfy pour alertes critiques, voice pour annonces de phase', en: 'ntfy for critical alerts, voice for phase announcements', nl: 'ntfy voor kritieke waarschuwingen, spraak voor fase-aankondigingen' },
  'learn.wf.comm.a1': { fr: 'Ne pas surcharger ntfy — max 5 alertes/heure en regime normal', en: 'Don\'t flood ntfy — max 5 alerts/hour in normal regime', nl: 'ntfy niet overbelasten — max 5 waarschuwingen/uur in normaal regime' },
  // PRD entries
  'learn.prd.showcase': { fr: 'MultiPass Showcase Build', en: 'MultiPass Showcase Build', nl: 'MultiPass Showcase Build' },
  'learn.prd.theme': { fr: 'Theme Toggle Dark/Light', en: 'Theme Toggle Dark/Light', nl: 'Thema Schakelaar Dark/Light' },
  'learn.prd.e2e': { fr: 'Pipeline E2E Playwright', en: 'E2E Playwright Pipeline', nl: 'E2E Playwright Pipeline' },
  'learn.prd.docker': { fr: 'Docker Memory Limits + Neo4j', en: 'Docker Memory Limits + Neo4j', nl: 'Docker Geheugenlimieten + Neo4j' },
  'learn.prd.production': { fr: 'Mise en Production', en: 'Production Deployment', nl: 'Productie Deployment' },
  'learn.prd.hardening': { fr: 'Security Hardening 5 VMs', en: 'Security Hardening 5 VMs', nl: 'Beveiliging Hardening 5 VMs' },
  'learn.prd.farmsysteme': { fr: 'FarmSysteme v1.0', en: 'FarmSystem v1.0', nl: 'FarmSysteem v1.0' },
  'learn.prd.agency2': { fr: 'MultiPass Agency v2.0', en: 'MultiPass Agency v2.0', nl: 'MultiPass Agency v2.0' },
  // PRD statuses
  'learn.status.complete': { fr: 'Termine', en: 'Complete', nl: 'Voltooid' },
  'learn.status.inprogress': { fr: 'En Cours', en: 'In Progress', nl: 'In Uitvoering' },
  'learn.status.planned': { fr: 'Planifie', en: 'Planned', nl: 'Gepland' },
  'learn.status.blocked': { fr: 'Bloque', en: 'Blocked', nl: 'Geblokkeerd' },
